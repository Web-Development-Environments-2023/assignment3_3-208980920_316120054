  ...
  <div class="container-page"> 
    ...
    <div class="container">
        ...
        <div v-if="this.recipe.owner">
            <p>The Recipe Of: {{ this.recipe.owner}}</p>
            <p>The recommendation for preparing the recipe is at the following events - {{ this.recipe.appointed_time }}</p>
        </div>
